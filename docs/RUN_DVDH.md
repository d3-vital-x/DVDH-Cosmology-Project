...
2. Copy `02_MODEL_CORE/class_patch/dvdh.ini` into your CLASS working folder (or point to it).
3. Apply the CLASS patch (if you used the background_dvdh module) or include background_dvdh.c into CLASS source and recompile:
   ...
   - otherwise add the provided files into CLASS source and run `make`
